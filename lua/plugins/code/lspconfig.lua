...
--         return nvim_lsp.utilroot_pattern { '*.yml', '*.yaml' }(fname)
--       end,
--   settings = {
--     ansible = {
--       ansible = {
...
--   },
--   root_dir = function(fname)
--     return nvim_lsp.utilroot_pattern('package.json', '.git')(fname) or nvim_lsp.utilpath.dirname(fname)
--   end,
--   settings = {}
-- }
...
--           'pyrightconfig.json',
--         }
--         return nvim_lsp.util.root_pattern(unpack(root_files))(fname) or nvim_lsp.utilfind_git_ancestor(fname) or nvim_lsp.utilpath.dirname(fname)
--       end,
--   settings = {
--     python = {
--       analysis = {
